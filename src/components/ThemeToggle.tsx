...
export default function ThemeToggle({
  ...
  const inputId = propId || `darkmode-toggle-${autoId}`;
  ...
  const labelText = ariaLabel || (isDark ? 'Switch to light mode' : 'Switch to dark mode');

  return (
    <div className={`my-body ${className}`.trim()}>
